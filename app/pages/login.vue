...
<template>
    <UCard :ui="{ root: 'w-96', footer: 'space-y-4' }">
        ...
        <UForm id="login-form" :schema="loginSchema" :state="loginData" class="space-y-4" @submit="onSubmit">
        ...
        <template #footer>
            ...
            <UButton type="button" variant="link" to="/register" color="primary" :ui="{}">Register</UButton>
        </template>
    </UCard>
</template>